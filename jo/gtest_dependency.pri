...
exists($$GTEST_SRCDIR) {
    message("GTest source directory exists!")
} else {
    error("GTest source directory not found: $$GTEST_SRCDIR")
}
message("GTEST_SRCDIR: $$GTEST_SRCDIR")
message("GMOCK_SRCDIR: $$GMOCK_SRCDIR")
